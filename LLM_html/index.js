...
const modelFileName = 'https://huggingface.co/xinxingwu/LLM_Gemma/resolve/main/gemma-1.1-2b-it-gpu-int4.bin';


//'./models/gemma-1.1-2b-it-gpu-int4.bin'; /* Update the file name */
